...
import { ListaPendentesTable } from '../components/ListaPendentesTable'
...
export function PainelModeracaoPage() {
  ...
  const { data, isPending, isError, error } = usePendentesModeracao(pagina, TAMANHO_PAGINA)

  return (
    <main className="mx-auto flex min-h-svh w-full max-w-4xl flex-col gap-4 p-4 py-10">
